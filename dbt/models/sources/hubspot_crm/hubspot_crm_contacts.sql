...
WITH source AS (
    ...
    SELECT
        ...
        properties_is_onboarded_value,
        properties_hs_lead_status_value,
        ...
        TIMESTAMP_MILLIS(CAST(properties_notes_last_contacted_value AS INT64)) AS properties_notes_last_contacted_value,
